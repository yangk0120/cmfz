...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var flag;
            //  form 表单提交
            $("#enCode").mouseout(function () {
                $.post("${pageContext.request.contextPath}/code/checkCode",
                    "enCode=" + $("#enCode").val(),
                    function (res) {
                        if (res == "正确") {
                            flag = true;
                            $("#enCodeSpan").html(res).css({color: "green"});
                        } else {
                            flag = false;
                            $("#enCodeSpan").html(res).css({color: "red"});
                        }
                    },
                    "json");
            });
    ...
    <form id="loginForm" action="${pageContext.request.contextPath}/admin/login" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="name" id="adminName" class="text" maxlength="20"/>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="password" name="password" id="adminPassword" class="text" maxlength="20"
                           autocomplete="off"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="submit" class="loginButton" id="loginbtn" value="登录">
                </td>
            </tr>
            </tbody>
        </table>
